...
class PlusOnePage extends StatefulWidget {
  const PlusOnePage({super.key, required this.title});

  final String title;

  @override
  State<PlusOnePage> createState() => _PlusOnePageState();
}

class _PlusOnePageState extends State<PlusOnePage> {
  int firstNumber = 0;
  int secondNumber = 0;
  int result = 0;
  int score = 0;
